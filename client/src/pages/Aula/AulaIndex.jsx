...
import { AulaList } from "../../components/Aula/AulaList"

export function AulaIndex() {
    return (
        <>
            <section className="flex flex-col gap-2 mx-5">
                <div className="flex gap-2">
                    <Link to="/aula/create" className="flex items-center gap-2 text-white text-center rounded-xl bg-blue-500 my-2 p-4">
