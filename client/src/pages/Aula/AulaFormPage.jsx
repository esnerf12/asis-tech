...
import { createAula, deleteAula, updateAula, getAula } from "../../api/asistencia.api"
    ...
    useEffect(() => {
        async function loadAula() {
            if (params.id) {
                ...
                setValue('codigo_aula', res.data.codigo_aula)
            }
        }
        loadAula()
    }, [])
            ...
            <div className="">
                <form className="flex flex-col gap-2 px-80 py-2" onSubmit={onSubmit}>
                    <label className="flex justify-center items-center gap-2 py-2">
                        ...
                        <span className="text-xl border-b-2 border-blue-800">Crear aula</span>
                    </label>
                    <label className="flex justify-start items-center gap-2" htmlFor="codigo_aula">
                        <span className="text-lg">Código de aula</span>
                        ...
                        { errors.codigo_aula && <li className="text-red-600">El nombre es requerido.</li> }
                    </label>
                    <input className="border-2 border-black rounded-md p-2" type="text" {...register('codigo_aula', {required: true})} />
