export function PlanificacionIndex() {
    return (
        <>
            <section className="flex flex-col gap-2 mx-5">
                <div className="flex gap-2">
                    <button className="flex items-center gap-2 text-white text-center rounded-xl bg-blue-500 my-2 p-4">
                ...
                <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-blue-400 dark:text-gray-800">
                            <tr>
