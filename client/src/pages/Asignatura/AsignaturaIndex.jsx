...
import { AsignaturaList } from "../../components/Asignatura/AsignaturaList"
import { useState } from "react"

export function AsignaturaIndex() {
        ...
        <>
            <section className="flex flex-col gap-2 mx-5">
                <div className="flex gap-2">
                    <Link to="/asignatura/create" className="flex items-center gap-2 text-white text-center rounded-xl bg-blue-500 my-2 p-4">
                    ...
                    <button className="flex items-center gap-2 text-white text-center rounded-xl bg-orange-500 my-2 p-4">
                        <span>Imprimir</span>
                    ...
                    <button className="flex items-center gap-2 text-white text-center rounded-xl bg-green-500 my-2 p-4">
                        <span>Exportar</span>
                    ...
                    <input type="search" placeholder="Buscar..." value={searchTxt} onChange={e => setSearchTxt(e.target.value)}/>
                </div>
                <AsignaturaList searchTxt={searchTxt}></AsignaturaList>
            </section>
        </>
    )
}
